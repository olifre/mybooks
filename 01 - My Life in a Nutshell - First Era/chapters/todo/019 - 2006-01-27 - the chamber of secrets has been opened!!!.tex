...
You can be sure another post is to come, but I'm not sure when it will be finished, and if it will contain much more information apart from poetry, as this one's about 150 % length of the "standard" I've tried to apply till now; but life's not predictable, and you shouldn't try. 
